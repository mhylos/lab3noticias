        ...
        <div class="row">
            <div class="col">
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <?php
                    $buscar = $_POST['buscar'];
                    // Buscamos lo que tenemos en la base de datos para mostrarla en una tabla
                    $sql = "SELECT id, titulo, imagen, resumen, noticia, fecha FROM tabla_noticia WHERE titulo like '$buscar' '%' order by id desc";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="eliminar.php? id=<?php echo $mostrar[0] ?>" type="button"
                ...
                <center><a href="insertar_noticia.php" type="button" class="text-center btn btn-primary">Insertar</a>
                </center>
            </div>
        </div>
    </div>
